...
export default function ResultsPage() {
  ...
  const handleClick = async (e) => {
    ...
    const res = await axios.get(`${process.env.REACT_APP_SERVER_URL}/ds/${textDescription}/${city}`);
  ...
  return (
    <div className={loadIn ? "page_container load_in" : "page_container load_out"}>
      ...
      <div className="text-description-container">
        <label htmlFor="userDescription">Don't see what you're looking for?</label>
        <textarea
